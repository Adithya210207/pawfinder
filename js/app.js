...
// Static Mock Data for offline/GitHub Pages deployment
const MOCK_DATA = {
  dogs: [
    { id: 'd1', name: 'Bruno', breed: 'Indie / Desi Dog', age_text: '2 yrs', gender: 'Male', weight_kg: 18, size: 'Medium', emoji: '🐕', location: 'RS Puram, Coimbatore', shelter_id: 's1', shelter_name: 'Paws & Claws Rescue', about: 'Friendly, playful Indie dog rescued from RS Puram. Loves walks and plays well with kids.', vaccinated: 1, neutered: 1, dewormed: 1, microchipped: 1, good_with: 'Kids, Dogs', energy_level: 'High', traits: 'Playful, Loving, Loyal', urgent: 0, featured: 1 },
    { id: 'd2', name: 'Bella', breed: 'Golden Retriever Mix', age_text: '1.5 yrs', gender: 'Female', weight_kg: 22, size: 'Large', emoji: '🦮', location: 'Peelamedu, Coimbatore', shelter_id: 's2', shelter_name: 'Coimbatore Hope Shelter', about: 'Gentle soul needing immediate foster or adoption. Very affectionate and house-trained.', vaccinated: 1, neutered: 1, dewormed: 1, microchipped: 1, good_with: 'Everyone', energy_level: 'Medium', traits: 'Gentle, Calm, Smart', urgent: 1, featured: 0 },
    { id: 'd3', name: 'Rocky', breed: 'Labrador Mix', age_text: '3 yrs', gender: 'Male', weight_kg: 26, size: 'Large', emoji: '🐕‍🦺', location: 'Ganapathy, Coimbatore', shelter_id: 's3', shelter_name: 'Compassion Haven', about: 'Active and enthusiastic boy. Great companion for active families and outdoor lovers.', vaccinated: 1, neutered: 1, dewormed: 1, microchipped: 1, good_with: 'Adults, Dogs', energy_level: 'High', traits: 'Energetic, Protective', urgent: 0, featured: 0 },
    { id: 'd4', name: 'Daisy', breed: 'Beagle Mix', age_text: '1 yr', gender: 'Female', weight_kg: 12, size: 'Small', emoji: '🐶', location: 'RS Puram, Coimbatore', shelter_id: 's1', shelter_name: 'Paws & Claws Rescue', about: 'Sweet and curious little girl. Loves cuddling and exploring new smells.', vaccinated: 1, neutered: 0, dewormed: 1, microchipped: 0, good_with: 'Kids, Cats', energy_level: 'Medium', traits: 'Curious, Gentle', urgent: 0, featured: 0 },
    { id: 'd5', name: 'Max', breed: 'German Shepherd Mix', age_text: '4 yrs', gender: 'Male', weight_kg: 28, size: 'Large', emoji: '🐕', location: 'Peelamedu, Coimbatore', shelter_id: 's2', shelter_name: 'Coimbatore Hope Shelter', about: 'Highly intelligent and loyal guard/family companion. Needs space to run.', vaccinated: 1, neutered: 1, dewormed: 1, microchipped: 1, good_with: 'Adults', energy_level: 'High', traits: 'Alert, Loyal, Guard', urgent: 1, featured: 0 },
    { id: 'd6', name: 'Luna', breed: 'Indie Pup', age_text: '4 mos', gender: 'Female', weight_kg: 6, size: 'Small', emoji: '🐾', location: 'Ganapathy, Coimbatore', shelter_id: 's3', shelter_name: 'Compassion Haven', about: 'Adorable rescued puppy looking for her forever family. First shots done.', vaccinated: 1, neutered: 0, dewormed: 1, microchipped: 0, good_with: 'Everyone', energy_level: 'Playful', traits: 'Puppy, Cute, Sweet', urgent: 0, featured: 0 }
  ],
  shelters: [
    { id: 's1', name: 'Paws & Claws Animal Rescue', emoji: '🏥', address: '124 DB Road, RS Puram', city: 'Coimbatore', phone: '+91 98765 43210', email: 'contact@pawsclaws.in', hours: '9 AM - 6 PM', distance_km: 2.4, dogs_available: 12, dogs_rehomed: 340, volunteers: 45, rating: 4.8, verified: 1, tags: ['24/7 Care', 'Medical Facility', 'No-Kill Shelter'] },
    { id: 's2', name: 'Coimbatore Hope Shelter', emoji: '🐕', address: '45 Avinashi Road, Peelamedu', city: 'Coimbatore', phone: '+91 98765 12345', email: 'help@hopeshelter.in', hours: '10 AM - 5 PM', distance_km: 5.1, dogs_available: 18, dogs_rehomed: 510, volunteers: 80, rating: 4.9, verified: 1, tags: ['Large Play Area', 'Foster Program', 'Volunteer Hub'] },
    { id: 's3', name: 'Compassion Animal Haven', emoji: '🐾', address: '88 Sathy Road, Ganapathy', city: 'Coimbatore', phone: '+91 98765 67890', email: 'info@compassionhaven.in', hours: '9 AM - 5 PM', distance_km: 3.8, dogs_available: 8, dogs_rehomed: 195, volunteers: 30, rating: 4.7, verified: 1, tags: ['Indie Rescue Special', 'Puppy Care'] }
  ],
  user: { id: 'u1', name: 'Adithya', email: 'demo@pawfinder.in', phone: '+91 98765 00000', city: 'Coimbatore', avatar_initials: 'AD', paw_points: 120, is_admin: 1 }
};
