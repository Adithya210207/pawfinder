...
const MOCK_DATA = {
  ...
  articles: [
    ...
    { id: 'a4', title: 'Understanding indie dog behavior', category: 'Training', emoji: '🐕', read_time: '5 min', author: 'Meera Sundaram, Canine Behaviorist', summary: 'A guide to living with Indian street dogs', likes: 187, bg_color: '#2a2a1a' },
    ...
    { id: 'a6', title: 'India stray dog crisis: 62 million animals', category: 'Awareness', emoji: '🇮🇳', read_time: '7 min', author: 'PawFinder Research Team', summary: 'The numbers behind the problem and what individuals can do', likes: 631, bg_color: '#2a1a2a' },
    { id: 'a7', title: 'Dog nutrition basics for Indian households', category: 'Nutrition', emoji: '🍚', read_time: '5 min', author: 'Dr. Kavitha Raman, Veterinary Nutritionist', summary: 'What to feed your dog — the Indian edition', likes: 203, bg_color: '#2a2a1a' },
    { id: 'a8', title: 'Monsoon care for your dog', category: 'Health', emoji: '☔', read_time: '4 min', author: 'Dr. Priya Sharma', summary: 'Keep your furry friend safe during the rainy season', likes: 167, bg_color: '#1a2a3a' },
    { id: 'a9', title: 'Positive reinforcement training 101', category: 'Training', emoji: '🧠', read_time: '6 min', author: 'Meera Sundaram, Canine Behaviorist', summary: 'The science-backed way to train your dog', likes: 278, bg_color: '#2a1a3a' },
    { id: 'a10', title: 'The joy of senior dog adoption', category: 'Stories', emoji: '🐾', read_time: '4 min', author: 'PawFinder Community', summary: 'Why older dogs make the best companions', likes: 198, bg_color: '#1a2a1a' },
    { id: 'a11', title: 'Beating the Coimbatore summer: heat care for dogs', category: 'Health', emoji: '🌡️', read_time: '5 min', author: 'Dr. Rajesh Kumar, Veterinarian', summary: 'How to keep your dog safe through Kovai summers', likes: 241, bg_color: '#2a1a1a' },
    { id: 'a12', title: 'A Coimbatore guide to your first vet visit', category: 'Health', emoji: '🩺', read_time: '5 min', author: 'Dr. Anitha Rao', summary: 'What to expect and how to prepare in Kovai', likes: 176, bg_color: '#1a1a2a' },
    { id: 'a13', title: 'Adopting in an apartment: making it work', category: 'Tips', emoji: '🏢', read_time: '4 min', author: 'PawFinder Team', summary: 'Yes, you can give a rescue a great life in a flat', likes: 149, bg_color: '#1a2a1a' },
    { id: 'a14', title: "From street to sofa: Bruno's story", category: 'Stories', emoji: '💛', read_time: '3 min', author: 'PawFinder Community', summary: 'One construction-site rescue, one forever family', likes: 221, bg_color: '#2a2a1a' },
    { id: 'a15', title: 'Spaying and neutering: myths vs facts', category: 'Awareness', emoji: '♻️', read_time: '5 min', author: 'Dr. Kavitha Raman, Veterinary Nutritionist', summary: 'Why sterilisation is the kindest choice', likes: 188, bg_color: '#2a1a2a' },
    { id: 'a16', title: 'Body condition: is your dog the right weight?', category: 'Nutrition', emoji: '⚖️', read_time: '4 min', author: 'Dr. Kavitha Raman, Veterinary Nutritionist', summary: 'A simple at-home check every owner should know', likes: 134, bg_color: '#2a2a1a' },
    { id: 'a17', title: 'First week with your rescue: a day-by-day plan', category: 'Tips', emoji: '📅', read_time: '6 min', author: 'Meera Sundaram, Canine Behaviorist', summary: 'The 3-3-3 rule for a calm transition', likes: 207, bg_color: '#1a2a3a' },
    { id: 'a18', title: 'How the PawFinder adoption process works', category: 'Awareness', emoji: '📋', read_time: '4 min', author: 'PawFinder Team', summary: 'From application to adoption day, step by step', likes: 263, bg_color: '#2a1a2a' },
    { id: 'a19', title: 'What documents you need to adopt', category: 'Awareness', emoji: '🪪', read_time: '4 min', author: 'PawFinder Team', summary: 'The paperwork checklist before you apply', likes: 172, bg_color: '#1a2a1a' },
    { id: 'a20', title: 'Introducing your new dog to other pets', category: 'Training', emoji: '🐾', read_time: '5 min', author: 'Meera Sundaram, Canine Behaviorist', summary: 'Slow, safe introductions that actually work', likes: 158, bg_color: '#2a1a3a' },
    { id: 'a21', title: 'Decoding dog barking and vocalisations', category: 'Training', emoji: '🔊', read_time: '4 min', author: 'Dr. Anitha Rao', summary: 'What your dog is really trying to say', likes: 141, bg_color: '#1a1a2a' },
    { id: 'a22', title: 'Adopting a dog with kids at home', category: 'Tips', emoji: '👶', read_time: '5 min', author: 'Dr. Priya Sharma', summary: 'Raising children and rescues together, safely', likes: 176, bg_color: '#2a2a1a' },
    { id: 'a23', title: 'Travelling around Coimbatore with your dog', category: 'Tips', emoji: '🚗', read_time: '4 min', author: 'PawFinder Team', summary: 'Safe, stress-free trips across Kovai', likes: 129, bg_color: '#1a2a3a' },
    { id: 'a24', title: 'Caring for a senior dog', category: 'Health', emoji: '🦴', read_time: '5 min', author: 'Dr. Rajesh Kumar, Veterinarian', summary: 'Helping your old friend age comfortably', likes: 163, bg_color: '#2a1a2a' },
    { id: 'a25', title: "From foster to forever: Mango's journey", category: 'Stories', emoji: '💛', read_time: '3 min', author: 'PawFinder Community', summary: 'How one foster home changed everything', likes: 211, bg_color: '#1a1a1a' },
    { id: 'a26', title: 'Recognising a pet emergency', category: 'Health', emoji: '🚑', read_time: '5 min', author: 'Dr. Kavitha Raman, Veterinary Nutritionist', summary: 'Know the red flags and act fast', likes: 184, bg_color: '#2a2a2a' }
  ],
  applications: [
